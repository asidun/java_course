...
public interface CalendarService extends Remote {
    ...
    void addEvent2(String name, String description, GregorianCalendar startDate, GregorianCalendar endDate, List<Person> attenders, EventType type) throws RemoteException;
    ...
    List<Event>  searchEventByTimeForAttender(GregorianCalendar date, Person attender) throws RemoteException;
}
